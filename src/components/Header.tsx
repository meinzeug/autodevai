...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header 
      className={`bg-gray-800 shadow-sm border-b border-gray-700 ${className}`}
      role="banner"
    >
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              className="flex items-center gap-2 p-2 rounded-full hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
