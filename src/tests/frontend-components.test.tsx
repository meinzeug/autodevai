...
const mockTauriService = {
  getInstance: jest.fn(() => ({
    onToolStatusUpdate: jest.fn(() => jest.fn()),
    getToolStatus: jest.fn(() => Promise.resolve([])),
...
describe('OutputDisplay Component', () => {
  ...
  test('handles export functionality', () => {
    ...
    jest.spyOn(document, 'createElement').mockReturnValue(mockA);
    jest.spyOn(document.body, 'appendChild').mockImplementation();
    jest.spyOn(document.body, 'removeChild').mockImplementation();
    jest.spyOn(mockA, 'click').mockImplementation();
...
describe('StatusBar Component', () => {
  ...
  beforeEach(() => {
    ...
    mockTauriService.getInstance().getToolStatus.mockResolvedValue(mockToolStatuses);
  ...
  test('shows healthy status when all tools are active', async () => {
    ...
    mockTauriService.getInstance().getToolStatus.mockResolvedValue(healthyToolStatuses);
  ...
  test('limits displayed tools to 4 and shows more count', async () => {
    ...
    mockTauriService.getInstance().getToolStatus.mockResolvedValue(manyTools);
