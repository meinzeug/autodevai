...
This document provides a comprehensive reference for all Tauri commands available in the AutoDev-AI
Neural Bridge Platform. These commands enable frontend-to-backend communication via IPC
...
This API provides comprehensive access to all Tauri application features while maintaining security
and performance through validation, rate limiting, and efficient state management.
